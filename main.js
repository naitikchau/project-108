...
function gotResult(error, results)
{
    ...
    else
    {
        ...
        document.getElementById("result_count").style.fontFamily = 'Courier New'+","+'Courier'+","+'monospace';
        ...
        if(results[0].label == "Barking"){
            ...
            dog = dog+1;
            document.getElementById("result_count").innerHTML = "Detected Dog - "+ dog;
        }
        else if(results[0].label == "Meowing"){
            img.src = "https://shravaripatil.github.io/Sound_controlled_animals/meow.gif";
            cat = cat+1;
            document.getElementById("result_count").innerHTML = "Detected Cat - "+ cat;
        }
            ...
            lion = lion+1;
            document.getElementById("result_count").innerHTML = "Detected Lion - "+ lion;
        }
            ...
            cow = cow+1;
            document.getElementById("result_count").innerHTML = "Detected Cow - "+ cow;
        }
        else{
            img.src = "https://shravaripatil.github.io/Sound_controlled_animals/listen.gif";
            background_noise = background_noise+1;
            document.getElementById("result_count").innerHTML = "Detected Background Noise - "+ background_noise;
        }
    }
}